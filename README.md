...
* lambdaliftermk5_2.hs

  演習 6.12 まで対応。

### Mark 6: 依存関係分析

* 演習6.13_解答案.md, 演習6.13_解答案.pdf

  演習 6.13 の(非形式的な)証明。  
  同値類が頂点集合を分割する部分については、公開されていた以下の資料の補題 5.10 を参考にさせていただきました。
  https://www.math.is.tohoku.ac.jp/~obata/student/subject/file/2018-5_douchi.pdf

* lambdaliftermk6.hs

  演習 6.16 の手前まで対応。(6.14, 6.15 の証明には未対応の状態。)

* lambdaliftermk6_2.hs

  演習 6.16 まで対応。(6.14, 6.15 の証明には未対応の状態。)
